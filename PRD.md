...
```
┌─────────────────────────────────────────────────────────────┐
│                    HEADER - FAZENDA SERRINHA                │
│                     [Logo] [Menu de Navegação]              │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  🌿 BEM-VINDO À FAZENDA SERRINHA 🌿                        │
│                                                             │
│  ┌─────────────────────────────────────────────────────┐   │
...
│                                                             │
│  ┌─ RESUMO RÁPIDO ────────────────────────────────────┐   │
│  │ Total Participantes: X                             │   │
│  │ Total Hospedagem: R$ XXX,XX                        │   │
│  │ Total Evento: R$ XXX,XX                            │   │
...
- Resumo lateral/inferior com totais
...
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  🧾 RESUMO DA INSCRIÇÃO E PAGAMENTO                        │
│                                                             │
...
│  │                                                     │   │
│  │ 👤 Participante 1: [Nome]                          │   │
│  │    Hospedagem: [Tipo] - [Período] = R$ XXX,XX      │   │
│  │    Evento: [Opção] = R$ XXX,XX                     │   │
│  │                                                     │   │
│  │ 👤 Participante 2: [Nome]                          │   │
│  │    Hospedagem: [Tipo] - [Período] = R$ XXX,XX      │   │
│  │    Evento: [Opção] = R$ XXX,XX                     │   │
...
│  │ ─────────────────────────────────                   │   │
│  │ Subtotal Geral:         R$ XXX,XX                   │   │
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
│  ┌─ CUPOM DE DESCONTO ───────────────────────────────────┐   │
│  │ Código: [____________] [APLICAR CUPOM]               │   │
│  │ ✅ Desconto aplicado: -R$ XX,XX (CUPOMVALIDO)       │   │
...
│  │     • Detalhes do evento                            │   │
│  │                                                     │   │
│  │  💳 Para PIX: Aguarde a chave no e-mail             │   │
│  │  🏦 Para Cartão: Você será redirecionado            │   │
│  │                                                     │   │
│  │  ❓ Dúvidas? Entre em contato:                      │   │
│  │     • WhatsApp: (XX) XXXXX-XXXX                     │   │
│  │     • E-mail: contato@fazendaserrinha.com.br        │   │
│  │                                                     │   │
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
...
- Instruções específicas por tipo de pagamento
- Informações de contato para suporte
- Opções para nova inscrição ou retorno ao início
